"""
DeepEval scaffold — pmo_agent / stock swing 用のeval例
セットアップ:
...
実行:
  deepeval test run evals/test_pmo_agent.py
  # または pytest evals/ -v
"""
import pytest
