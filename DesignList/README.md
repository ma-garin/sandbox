...
│   ├── material/         Material Design 3 風（tokens + components）
│   │   ├── index.html
│   │   └── material.css
│   └── carbon/           IBM Carbon 風（tokens + components）
│       ├── index.html
│       └── carbon.css
...
| スタイル | 特徴 | 主な用途 |
|---|---|---|
| **Material Design 3** | 大きな角丸・トーナルカラー・状態レイヤー・エレベーション | 親しみやすく動きのあるUI |
| **IBM Carbon 風** | 角ばった形状・機能的グレー・Blue 60・高い情報密度 | 業務／エンタープライズ系 |
