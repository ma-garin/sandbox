 ...
 *   資料 — 実物は見ていないが、項目の並びを載せた資料で確かめたもの（source: 'doc'）
 *
 * 実物も資料も無い寺社を名指ししない。項目を推し量って埋めれば数はそろうが、
 * それは出どころのない一覧になる。
 *
 * 探したが項目の載った資料が見つからず、入れていないもの:
 *   日枝神社・鶴岡八幡宮・富岡八幡宮・大國魂神社・成田山新勝寺
 * いずれも「仕事運に厚い」「凶が多い」といった評ばかりで、項目の並びを
 * 書き起こした資料に行き当たらなかった。実物を引いたら足せる。
 */
...
export const OMIKUJI_PRESETS = [
  ...
  {
    id: 'general-full',
    name: '一般的なおみくじ（詳しい・20項目）',
    note: '項目の多い型。載っていない項目は空のままでよい。',
    source: 'common',
    shrine: null,
    hasPoem: true,
    items: ['願望', '健康', '体調', '仕事', '交渉', '恋愛', '縁談', '待人', '失物', '出産',
      '金運', '商売', '相場', '学問', '学業', '受験', '技芸', '転居', '旅行', '争事'],
  },
  {
    id: 'sensoji',
    name: '浅草寺 観音百籤',
    note: '古い仮名づかいのまま刷られている。凶が多いことで知られる。',
    source: 'doc',
    shrine: '浅草寺',
    hasPoem: true,
    items: ['願', '病人', '失もの', '待人', 'やづくり', 'ひきこし', 'たびだち', 'よめとり・むことり'],
  },
  {
    id: 'yushima',
    name: '湯島天満宮（湯島天神）',
    note: '菅原道真公の御歌が添えられる。学問ではなく「学業」と書く。',
    source: 'doc',
    shrine: '湯島天満宮',
    hasPoem: true,
    items: ['願望', '待人', '失物', '旅行', '商売', '方角', '学業', '争事', '転居', '出産', '病気', '縁談'],
  },
  {
    id: 'kawasaki-daishi',
    name: '川崎大師 平間寺',
